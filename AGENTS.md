...
- **Règle 0 — Pas de code sans preuve** : Avant d'écrire la moindre ligne de code d'un nouvel algorithme, il faut obligatoirement démontrer : 1. le problème observé, 2. la métrique de mesure associée, 3. la valeur actuelle (baseline), 4. la valeur cible visée, et 5. le fichier exact cible.
