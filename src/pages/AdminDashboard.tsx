...
const ServiceManager = React.lazy(() => import('../components/admin/ServiceManager'));
...
const PortfolioManager = React.lazy(() => import('../components/admin/PortfolioManager'));
const MessageManager = React.lazy(() => import('../components/admin/MessageManager'));
const UserManager = React.lazy(() => import('../components/admin/UserManager'));
const DesignRequestManager = React.lazy(() => import('../components/admin/DesignRequestManager'));
const ExpenseManager = React.lazy(() => import('../components/admin/ExpenseManager').then(m => ({ default: m.ExpenseManager })));
const StudioAcomManager = React.lazy(() => import('../components/admin/StudioAcomManager'));
const PlatformAIInsights = React.lazy(() => import('../components/admin/PlatformAIInsights').then(m => ({ default: m.PlatformAIInsights })));
import { ConfirmModal } from '../components/admin/ConfirmModal';
const AcomSaaSManager = React.lazy(() => import('../components/admin/AcomSaaSManager').then(m => ({ default: m.AcomSaaSManager })));
const AcomSaaSSettings = React.lazy(() => import('../components/admin/AcomSaaSSettings').then(m => ({ default: m.AcomSaaSSettings })));
